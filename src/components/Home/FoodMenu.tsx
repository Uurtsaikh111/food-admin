...
return(
       ...
       {data?.map((a,id)=>{
        return (
            <Stack key={id} px={2}  border={"1px solid #D6D8DB"} justifyContent={"space-between"} direction={"row"} borderRadius={1}>
             <Typography display={"flex"} fontSize={"18px"} fontWeight={550} alignItems={"center"}>{a.name}</Typography>
